...
crondigest version, as reported by ``crondigest --version``

### Installation Method

How was crondigest installed (provide as much detail as possible, ideally
...
that crondigest is running in, as well as your operating system type and version.

### Actual Output

```
Paste here the output of crondigest (including the command used to run it),
