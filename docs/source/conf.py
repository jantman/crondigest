# -*- coding: utf-8 -*-
#
# crondigest documentation build configuration file, created by
...
from crondigest.version import VERSION
...
if is_rtd:
    ...
    htmlhelp_basename = 'crondigestdoc'
...
latex_documents = [
  (master_doc, 'crondigest.tex', u'crondigest Documentation',
...
man_pages = [
    (master_doc, 'crondigest', u'crondigest Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'crondigest', u'crondigest Documentation',
   author, 'crondigest', 'One line description of project.',
   'Miscellaneous'),
]
...
linkcheck_ignore = [
    ...
    r'https?://codecov\.io.*',
    r'https?://.*readthedocs\.org.*',
    r'https?://pypi\.python\.org/pypi/crondigest'
]
